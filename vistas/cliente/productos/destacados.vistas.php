...
<div class="card"><!--inicio de destacados-->
          ...
          <div class="carousel-inner" style=" text-align: center;">
            <div class="carousel-item active" >
              <div class="d-block w-100" alt="First slide">
                <img src="./images/alambrismo-corazones.png"  >
                <div class="carousel-caption d-none d-md-block">
                  <h5>producto1</h5>
                  <p>descripcion</p>
                  <button type="button" style="color: #7624FC;">agregar al carrito</button>
                </div>      
              </div>
            </div>
            ...
            <div class="carousel-item ">
              <div class="d-block w-100"  alt="Third slide">                
                <img src="./images/aretes-mostilla-acero.png">
                <div class="carousel-caption d-none d-md-block">
                  <h5>producto3</h5>
                  <p>descripcion</p>
                  <button type="button" style="color: #7624FC;">agregar al carrito</button>
