  ...
  <div class="row">
    <div class="col-8">
      ...
      <div class="form-group  ">
        ...
        <div class="row mb-4  ">
          ...
          <div class="col-2 text-center">
            <img src="./././images/alambrismo-corazones.png" alt="sin imagen" class="w-25">
          </div>
        ...
        <div class="row mb-4  ">
          ...
          <div class="col-2 text-center">
            <img src="./././images/alambrismo-rombos-arcoiris.png" alt="sin imagen" class="w-25">
          </div>
        ...
        <div class="row mb-4  ">
          ...
          <div class="col-2 text-center">
            <img src="./././images/aretes-mostilla-acero.png" alt="sin imagen" class="w-25">
          </div>
      ...
      <div class="">
        ...
        <img src="./././images/pse.png" width="75" height="75">
        ...
        <div class="imagen ">
          <img class="imagen" src="./././images/tarjeta.png" width="160" height="135">
